...
export abstract class MedicalRecordAllergiesRepository {
  abstract createMany(medicalRecordAllergies: MedicalRecordAllergy[]): Promise<void>;
  abstract deleteMany(medicalRecordAllergies: MedicalRecordAllergy[]): Promise<void>;
