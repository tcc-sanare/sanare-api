...
export class UpdateAccountPasswordUseCase {
    ...
    async execute (data: UpdateAccountPasswordUseCaseRequest): Promise<UpdateAccountPasswordUseCaseResponse> {
        ...
        const passwordCompare = await this.hashComparer.compare(data.oldPassword, account.password);
